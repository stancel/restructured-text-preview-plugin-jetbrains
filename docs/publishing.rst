...
+------------------+---------------+-------------------------------+
| IDE Version      | Build Number  | Notes                         |
+==================+===============+===============================+
| 2024.3           | 243.*         |                               |
+------------------+---------------+-------------------------------+
| 2025.1           | 251.*         |                               |
...
| 2025.2           | 252.*         |                               |
+------------------+---------------+-------------------------------+
| 2025.3           | 253.*         | Unified distribution (IC+IU)  |
+------------------+---------------+-------------------------------+
| 2026.1           | 261.*         |                               |
+------------------+---------------+-------------------------------+
...
Starting with 2025.3, IntelliJ IDEA Community Edition was merged into a
unified distribution. For plugin verification against 2025.3+, use
``IntelliJPlatformType.IntellijIdea`` instead of ``IntellijIdeaCommunity``.
